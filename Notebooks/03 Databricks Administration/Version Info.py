...
# MAGIC
# MAGIC * Name: **Get Started with Databricks Platform Administration**
# MAGIC * Version:  **1.0.0**
# MAGIC * Built On: **Nov 23, 2023 at 19:59:41 UTC**
...
# MAGIC
# MAGIC This course is tested against and requires one of the following DBRs (Databricks Runtime): **13.3.x-scala2.12, 13.3.x-photon-scala2.12, 13.3.x-cpu-ml-scala2.12**.
# MAGIC
