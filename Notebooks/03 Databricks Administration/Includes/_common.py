...
course_config = CourseConfig(course_code = "gswdpa",
                             course_name = "get-started-with-databricks-platform-administration-source",
                             data_source_name = "get-started-with-databricks-platform-administration-source",
