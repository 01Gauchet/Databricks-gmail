...
-- MAGIC %python
-- MAGIC #GVA
-- MAGIC strFileSore = 'dbfs:/FileStore/tables/'
-- MAGIC strMntTraining = 'dbfs:/mnt/'
-- MAGIC strTrainingData = 'dbfs:/mnt/dbacademy-datasets/data-engineer-learning-path/v04/'
-- MAGIC strTrainingUsers = 'dbfs:/mnt/dbacademy-users/'
-- MAGIC strRoot = '/'
-- MAGIC files = dbutils.fs.ls(strTrainingData)
-- MAGIC display(files)

-- COMMAND ----------

-- MAGIC %python
-- MAGIC DA.schema_name
