...
# MAGIC %sql
# MAGIC select 
# MAGIC DATEDIFF(day, TBL_FORECAST_START_DATE, TBL_FORECAST_END_DATE) AS Forecast_Duration
# MAGIC ,DATEDIFF(day, GETDATE(), TBL_FORECAST_END_DATE) AS Time_Remaining
# MAGIC ,(TBL_FORECAST_FULL_VALUE * TBL_FORECAST_PROBABILITY / 100) AS Expected_Revenue
# MAGIC ,TBL_FORECAST_BILLING / NULLIF(TBL_FORECAST_FTE, 0) AS Revenue_per_FTE
# MAGIC ,TBL_FORECAST_BILLING / NULLIF(TBL_FORECAST_HOURS, 0) AS Effective_Rate_per_Hour
# MAGIC from main.itb_forecasting.forecast_main
